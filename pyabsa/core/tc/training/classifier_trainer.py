            ...
            for i_batch, sample_batched in enumerate(iterator):
                ...
                if global_step % self.opt.log_step == 0:
                    if (
                        ...
                        postfix = (
                            "Epoch:{} | Loss:{:.4f} | Test Acc:{:.2f}(max:{:.2f}) |"
                            " Test F1:{:.2f}(max:{:.2f})".format(
                                epoch,
                                loss.item(),
                                test_acc * 100,
                                max_fold_acc * 100,
                        ...
                        if (
                            ...
                            if test_acc > max_fold_acc or f1 > max_fold_f1:
                                ...
                                if self.opt.model_path_to_save:
                                    ...
                                    if (
                                        test_acc
                                        > self.opt.max_test_metrics["max_test_acc"]
                                    ):
...
def train4tc(opt, from_checkpoint_path, logger):
    ...
    if hasattr(BERTTCModelList, opt.model.__name__):
        opt.inputs_cols = BERTTCDataset.bert_baseline_input_colses[

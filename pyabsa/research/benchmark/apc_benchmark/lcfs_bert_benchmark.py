...
def run_lcfs_bert_cdw(param_dict=None):
    if not param_dict:
        ...
        _apc_param_dict_english['model_name'] = APCModelList.LCFS_BERT
...
def run_lcfs_bert_cdm(param_dict=None):
    if not param_dict:
        print('No optimal hyper-parameters are set, using default params...')
        _apc_param_dict_english = copy.deepcopy(apc_config_handler.get_apc_param_dict_english())
        _apc_param_dict_english['model_name'] = APCModelList.LCFS_BERT

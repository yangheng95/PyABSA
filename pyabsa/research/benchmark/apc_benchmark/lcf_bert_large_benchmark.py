# -*- coding: utf-8 -*-
# file: lcf_bert_large_benchmark.py
# time: 2021/6/24
...
def run_lcf_bert_large_cdw(param_dict=None):
    if not param_dict:
        ...
        _apc_param_dict_english['model_name'] = APCModelList.LCF_BERT_LARGE
...
def run_lcf_bert_large_cdm(param_dict=None):
    if not param_dict:
        print('No optimal hyper-parameters are set, using default params...')
        _apc_param_dict_english = copy.deepcopy(apc_config_handler.get_apc_param_dict_english())
        _apc_param_dict_english['model_name'] = APCModelList.LCF_BERT_LARGE

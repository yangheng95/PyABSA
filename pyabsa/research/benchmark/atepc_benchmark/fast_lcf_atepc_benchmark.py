# -*- coding: utf-8 -*-
# file: fast_lcf_atepc_benchmark.py
# time: 2021/6/24
...
def run_fast_lcf_atepc_cdw(param_dict=None):
    if not param_dict:
        ...
        _atepc_param_dict_english['model_name'] = ATEPCModelList.FAST_LCF_ATEPC
...
def run_fast_lcf_atepc_cdm(param_dict=None):
    if not param_dict:
        print('No optimal hyper-parameters are set, using default params...')
        _atepc_param_dict_english = copy.deepcopy(atepc_config_handler.get_atepc_param_dict_english())
        _atepc_param_dict_english['model_name'] = ATEPCModelList.FAST_LCF_ATEPC

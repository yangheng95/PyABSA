...
def run_lcf_atepc_large_cdw(param_dict=None):
    if not param_dict:
        ...
        _atepc_param_dict_english['model_name'] = ATEPCModelList.LCF_ATEPC_LARGE
...
def run_lcf_atepc_large_cdm(param_dict=None):
    if not param_dict:
        print('No optimal hyper-parameters are set, using default params...')
        _atepc_param_dict_english = copy.deepcopy(atepc_config_handler.get_atepc_param_dict_english())
        _atepc_param_dict_english['model_name'] = ATEPCModelList.LCF_ATEPC_LARGE

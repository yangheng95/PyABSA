...
class PretrainedTokenizer:
    def __init__(self, config, **kwargs):
        ...
        self.eos_token_id = self.tokenizer.eos_token_id if self.tokenizer.eos_token_id else self.tokenizer.sep_token_id
        ...
        self.eos_token = self.tokenizer.eos_token if self.tokenizer.eos_token else self.tokenizer.sep_token

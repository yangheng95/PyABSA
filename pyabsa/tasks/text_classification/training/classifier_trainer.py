...
from pyabsa.dataset_utils import ClassificationDatasetList
...
class Instructor:
    def __init__(self, opt, logger):
        ...
        if hasattr(ClassificationModelList.BERTClassificationModelList, opt.model.__name__):
        ...
        elif hasattr(ClassificationModelList.GloVeClassificationModelList, opt.model.__name__):

# -*- coding: utf-8 -*-
# file: text_adversarial_defense.py
# time: 18:12 2022/12/15
    ...
    with gr.Row():
        with gr.Column():
            ...
            input_sentence = gr.Textbox(
                placeholder="Randomly choose a example from testing set if this box is blank",
                label="Sentence",
            )
            ...
            button_gen = gr.Button(
                "Click Here to Generate an Adversary and Run Adversary Detection & Repair"
            )
        ...
        with gr.Column():
            ...
            adv_text_diff = gr.HighlightedText(
                label="Adversarial Example Difference", combine_adjacent=True
            )
            restored_text_diff = gr.HighlightedText(
                label="Restored Example Difference", combine_adjacent=True
            )
            gr.Markdown(

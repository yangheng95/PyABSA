...
from pyabsa.config.apc_config import apc_config_manager
from pyabsa.dataset_utils import ABSADatasetList

###############################################################


apc_param_dict_english = apc_config_manager.get_apc_param_dict_english()
...
# apc_param_search(config_dict=apc_param_dict_english,

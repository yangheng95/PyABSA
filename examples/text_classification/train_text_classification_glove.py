...
classification_param_dict_english = classification_config_handler.get_classification_param_dict_glove()
classification_param_dict_english['model'] = ClassificationModelList.GloVeClassificationModelList.LSTM

...
param_dict = {'model_name': 'slide_lcfs_bert',    # {slide_lcfs_bert, slide_lcf_bert, lcfs_bert, lcf_bert, bert_spc, bert_base, lca_bert}
              'batch_size': 16,
...
datasets_path = 'apc_datasets/SemEval/laptop14'  # file or dir are accepted
...
datasets_path = 'apc_datasets/SemEval/restaurant15'  # file or dir are accepted
sent_classifier = train_apc(parameter_dict=param_dict,     # set param_dict=None to use default model
                            dataset_path=datasets_path,    # train set and test set will be automatically detected
                            model_path_to_save=save_path,  # set model_path_to_save=None to avoid save model
                            auto_evaluate=True,            # evaluate model while training if test set is available
...
datasets_path = 'apc_datasets/SemEval/restaurant16'  # file or dir are accepted
sent_classifier = train_apc(parameter_dict=param_dict,     # set param_dict=None to use default model
                            dataset_path=datasets_path,    # train set and test set will be automatically detected
                            model_path_to_save=save_path,  # set model_path_to_save=None to avoid save model
                            auto_evaluate=True,            # evaluate model while training if test set is available
...
#               'log_step': 3,               # Evaluate per steps
#               'SRD': 3,                    # Distance threshold to calculate local context
#               'use_syntax_based_SRD': False,   # force to use syntax-based semantic-relative distance
#               'eta': -1,                   # Eta is valid in [0,1] slide_lcf_bert/slide_lcf_bert
#               'sigma': 0.3,                # Sigma is valid in LCA-Net, ranging in [0,1]

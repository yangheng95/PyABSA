...
param_dict = {'model_name': 'slide_lcf_bert',   # {slide_lcf_bert, slide_lcf_bert, lcf_bert, lcfs_bert, bert_spc, bert_base}
              'batch_size': 16,
              'seed': {88, 688, 878},      # you can use a set of random seeds to train multiple rounds

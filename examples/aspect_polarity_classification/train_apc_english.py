...
apc_param_dict_english['model_name'] = APCModelList.SLIDE_LCF_BERT
# semeval = ABSADatasets.semeval
mams = ABSADatasets.mams
sent_classifier = train_apc(parameter_dict=apc_param_dict_english,     # set param_dict=None to use default model
                            dataset_path=mams,    # train set and test set will be automatically detected
